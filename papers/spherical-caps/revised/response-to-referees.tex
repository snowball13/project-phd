...
Explained via a comment in the relevant place. Typo has also been corrected in one equation in the section (missing z from $Q(x,y,z)$).
...
\bstodoinline{Reference Michael Slavinsky paper on Transforms, say it's an open problem.}
