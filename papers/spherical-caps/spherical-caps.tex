...
\begin{figure}[t]
	...
	\sotodoinline{For examples, having  nearby singularities (e.g. something like$f(\vc x) = \|\vc x - (1,1,1) * (1 /\sqrt 3 + \epsilon)\|$) should give different exponential convergence rates.}
	\bstodoinline{to do}
	}
	\centering
	\label{fig:helmholtz}
...
\begin{figure}[t]
	...
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
	\includegraphics[scale=0.3]{solutionblocknorms-biharmonic-N=100-xnolog}
	\centering
