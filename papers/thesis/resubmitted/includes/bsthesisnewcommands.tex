...
\newcommand{\quadfour}{\quadtwo \quadtwo}
\newcommand{\quadsix}{\quadtwo \quadtwo \quadtwo}
\newcommand{\quadeight}{\quadfour \quadfour}
...
\newcommand{\eimthetaprime}{e^{im'\theta}}
\newcommand{\phivec}{\hat{\bm{\phi}}}
\newcommand{\thetavec}{\hat{\bm{\theta}}}

\newcommand{\signfunc}[1]{\text{sgn}(#1)\:}
...
\newcommand{\rotrate}{\tilde \Omega}

% SH
\newcommand{\Ylm}{Y^m_l}
\newcommand{\Ylmprime}{Y_{l'}^{m'}}
\newcommand{\Ylmxyz}{\Ylm(x,y,z)}
\newcommand{\Ylmfull}{\Ylm(\varphi, \theta)}
\newcommand{\Plm}{\jac^m_l}
\newcommand{\jaclm}[2]{P^{(#2,#2)}_{#1-#2}}
\newcommand{\jaclmbracket}[2]{P^{(#2,#2)}_{#1-(#2)}}
\newcommand{\jaclmabs}[2]{P^{(\abs{#2},\abs{#2})}_{#1-\abs{#2}}}
\newcommand{\jaclmdz}[2]{P^{(#2,#2) \; \prime}_{#1-#2}}
\newcommand{\jaclmbracketdz}[2]{P^{(#2,#2) \; \prime}_{#1-(#2)}}
\newcommand{\jaclmabsdz}[2]{P^{(\abs{#2},\abs{#2}) \; \prime}_{#1-\abs{#2}}}
\newcommand{\jaclmuser}[2]{P^{(#2, #2)}_{#1}}
\newcommand{\jaclmuserdz}[2]{P^{(#2, #2) \; \prime}_{#1}}
\newcommand{\alphalm}{\alpha^m_l}
\newcommand{\clm}{c^m_l}
\newcommand{\clmprime}{c_{l'}^{m'}}
...
\newcommand{\gradY}{\vec{\Psi}}
%\newcommand{\gradYlm}{\nabla \Ylm}
%\newcommand{\gradYlmprime}{\nabla \Ylmprime}
\newcommand{\gradYlm}{\gradY_l^m}
\newcommand{\gradYlmprime}{\gradY_{l'}^{m'}}
\newcommand{\gradpY}{\vec{\Phi}}
%\newcommand{\gradpYlm}{\nabla^\perp \Ylm}
%\newcommand{\gradpYlmprime}{\nabla^\perp \Ylmprime}
\newcommand{\gradpYlm}{\gradpY_l^m}
\newcommand{\gradpYlmprime}{\gradpY_{l'}^{m'}}

\newcommand{\SHvec}{\bigP}
\newcommand{\SHvecl}{\SHvec_l}
\newcommand{\VSHvec}{\bigT^{\gradY}}
\newcommand{\VSHvecperp}{\bigT^{\gradpY}}
...
\newcommand{\uvecc}{\uvec^{\gradY c}}
\newcommand{\uvecnc}{\uvecc_n}
\newcommand{\uveccperp}{\uvec^{\gradpY c}}
\newcommand{\uvecncperp}{\uveccperp_n}
\newcommand{\fveccexp}{\tilde{\fvecc}}
