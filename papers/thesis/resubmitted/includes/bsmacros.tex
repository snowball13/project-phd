...
\def\bsrefchapter#1{Chapter~\ref{#1}}
\def\bsrefsection#1{Section~\ref{#1}}
\def\bsrefappendix#1{Appendix~\ref{#1}}

\def\bsrefeqn#1{equation (\ref{#1})}
\def\bsrefeqncapital#1{Equation (\ref{#1})}
\def\bsrefeqns#1#2{equations (\ref{#1}--\ref{#2})}
\def\bsrefeqnslist#1#2#3{equations (\ref{#1}), (\ref{#2}), (\ref{#3})}
\def\bsreflemma#1{Lemma~\ref{#1}}
\def\bsreftheorem#1{Theorem~\ref{#1}}
\def\bsrefprop#1{Proposition~\ref{#1}}
\def\bsrefcor#1{Corollary~\ref{#1}}
\def\bsrefdef#1{Definition~\ref{#1}}
\def\bsrefcondition#1{Condition~\ref{#1}}
\def\bsreffig#1{Figure~\ref{#1}}
\def\bsreffigs#1#2{Figures~\ref{#1}, \ref{#2}}
