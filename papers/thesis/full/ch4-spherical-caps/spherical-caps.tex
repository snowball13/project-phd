...
Another desirable operator is the Biharmonic operator $\DeltaS^2$, for which we assume zero Dirichlet and Neumann conditions. That is, \bstodo{All functions not dependent on r (ie any we expand in this basis) satisfy the derivative BC automatically. I am fairly sure this is still the BC for the sphere though..?}
\bseqn{
