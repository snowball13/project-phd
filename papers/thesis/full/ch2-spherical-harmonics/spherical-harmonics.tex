...
Further, the \textit{associated Legendre polynomials} are a set of polynomials orthogonal with respect to unit weight on the unit interval, and can be defined as the $m^{\text{th}}$ derivative of a Jacobi polynomial: \bstodo{Add citation for associated legendre polys}
\bseqn{
...
\bstodoinline{Is this para enough? coeffs/ transform}
...
\bstodoinline{Do I need to say more here? VSH Transform}
