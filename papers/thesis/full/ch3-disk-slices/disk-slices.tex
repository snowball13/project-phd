...
\bstodoinline{Does the above (on Zernike polys) make more sense? Is my understanding now correct?}
...
\bstodoinline{The above remark should hopefully make it clear that the $P$ polynomials henceforth are normalised (and for the disk-slice are normalised Jacobi polynomials) which is in contrast to the SH chapter.}
