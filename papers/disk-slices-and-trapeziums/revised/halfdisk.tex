...
\begin{align}
	...
	\jacw^{(c) \: \prime}(y) &= - 2c \: y \: \jacw^{(b-1)}(y), \label{eqn:derivativeofweightjac} \\
...
\noindent{\bf Remark}:  \bstodo{improve this remark}
...
\begin{figure}[t]
	...
	\centering
	\includegraphics[scale=0.5]{solutionblocknorms-poisson} %-diskslice-alpha=0p2-beta=0p8}
...
\begin{figure}[t]
	...
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
	\includegraphics[scale=0.5]{solutionblocknorms-helmholtz-k=20} %-diskslice-alpha=0p2-beta=0p8-N=196-k=20}
	\centering
